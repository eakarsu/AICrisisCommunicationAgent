...
/**
 * Gap/CFS Feature Page: Scenario stress testing
 * Slug: scenario-stress-testing
 * Backend: /api/cf-scenario-stress-testing
 */
export default function ScenarioStressTestingPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-scenario-stress-testing', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Scenario stress testing</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Simulate various crisis scenarios; test response plans; measure impact.</p>
