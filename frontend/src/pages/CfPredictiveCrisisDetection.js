...
/**
 * Gap/CFS Feature Page: Predictive crisis detection
 * Slug: predictive-crisis-detection
 * Backend: /api/cf-predictive-crisis-detection
 */
export default function PredictiveCrisisDetectionPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-predictive-crisis-detection', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Predictive crisis detection</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Monitor news, social media, employee chatter; flag emerging crises before they explode.</p>
