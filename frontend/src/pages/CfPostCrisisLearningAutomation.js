...
/**
 * Gap/CFS Feature Page: Post-crisis learning automation
 * Slug: post-crisis-learning-automation
 * Backend: /api/cf-post-crisis-learning-automation
 */
export default function PostCrisisLearningAutomationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-post-crisis-learning-automation', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Post-crisis learning automation</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Aggregate lessons learned from crises; recommend preventive improvements.</p>
